...
extension CustomRecurrenceViewController {
    ...
    fileprivate func unitStringForIntervalCell() -> String {
        ...
        return String(describing: recurrenceRule.interval) + " " + Constant.pluralUnitStrings()[recurrenceRule.frequency.number]
    }
    ...
    fileprivate func updateRecurrenceRuleText() {
        ...
        tableView.beginUpdates()
        footerView?.textLabel?.text = recurrenceRule.toText(on: occurrenceDate)
        tableView.endUpdates()
...
extension CustomRecurrenceViewController {
    ...
    override func tableView(_ tableView: UITableView, titleForFooterInSection section: Int) -> String? {
        if section == 0 {
            return recurrenceRule.toText(on: occurrenceDate)
        }
        return nil
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if isPickerViewCell(indexPath) {
            ...
            cell.interval = recurrenceRule.interval ?? 1
            ...
            if (indexPath as NSIndexPath).row == 0 {
                cell?.textLabel?.text = LocalizedString("PresetRecurrnece.TextLabel.Frequency")
                ...
                cell?.textLabel?.text = LocalizedString("PresetRecurrnece.TextLabel.Interval")
...
extension CustomRecurrenceViewController {
    ...
    fileprivate func commonInit() {
        ...
        let bundle = Bundle.recurrencePickerBundle() ?? Bundle.main
